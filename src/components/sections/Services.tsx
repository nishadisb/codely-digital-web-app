                ...
                <section className="container mx-auto px-6 relative z-10">
                    <Row gutter={[32, 32]}>
                                        ...
                                        <Col xs={24} sm={12} key={index}>
                                            <motion.div
                                                ...
                                                style={{
                                                    ...
                                                    background:
                                                        'linear-gradient(180deg, rgba(17,24,53,0.9) 0%, rgba(10,14,39,0.9) 100%)',
                                                    boxShadow:
                                            ...
                                            >
                                                ...
                                                <div className="absolute inset-0 bg-gradient-to-t from-[#0a0e27]/90 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 z-10" />
                                                ...
                                                <div className="absolute bottom-0 right-0 w-[80%] h-[60%] flex items-end justify-end z-10 translate-y-4 translate-x-4 group-hover:translate-y-0 group-hover:translate-x-0 group-hover:scale-105 transition-all duration-500 ease-out">
                                                    <motion.img
                                                        src={service.image}
                                                        alt={service.title}
                                                        className="w-full h-full object-contain object-bottom drop-shadow-[0_10px_30px_rgba(0,100,255,0.3)] group-hover:opacity-30 transition-opacity duration-300"
                        ...
                        <Col
                            xs={24}
                            lg={12}
                            className="flex flex-col lg:mt-24 order-1 lg:order-2"
                        >
                            <motion.div
                            ...
                            >
                                <div className="mb-10 lg:pl-10">
                                    <h2 className="text-4xl lg:text-7xl font-light text-white tracking-wide">
                                        What We Do
                                    </h2>
                                </div>
                            </motion.div>
                            ...
                            <motion.div
                                ...
                                viewport={{ once: true }}
                                whileHover="hover"
                                className="relative h-[420px] lg:h-[660px] rounded-[30px] overflow-hidden group cursor-pointer border border-white/5 transition-all duration-300 hover:-translate-y-2"
                                style={{
                                    backdropFilter: 'blur(10px)',
                                    background:
                                        'linear-gradient(90deg, rgba(17,24,53,0.9) 0%, rgba(14,23,81,0.9) 100%)',
                                    boxShadow:
                                        '0 20px 40px rgba(0,0,0,0.3)',
                                }}
                            >
                                ...
                                <div className="relative z-20 flex flex-col h-full p-8">
                                    ...
                                    <p className="text-gray-400 text-sm leading-relaxed opacity-80 group-hover:opacity-100 transition-opacity">
                                        Codely develops powerful software
                                        solutions tailored to business needs.
                                        From custom platforms to enterprise
                                        systems, we build scalable applications
